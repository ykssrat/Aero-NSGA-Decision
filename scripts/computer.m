...
%% 情况1: 需要参数7的数据库
PC_Problem.Components_WithCase.Param1 = [
    800,  70, 1, 0, 1;   % 型号1
    900,  75, 1, 0, 0;   % 型号2
    1000, 80, 0, 1, 1;   % 型号3
    1100, 85, 1, 0, 1;   % 型号4
...
PC_Problem.Components_WithCase.Param2 = [
    3500, 75, 1, 0, 1;
    4000, 80, 1, 0, 0;
    4500, 85, 0, 1, 1;
    5000, 90, 1, 0, 1;
...
PC_Problem.Components_WithCase.Param3 = [
    700,  70, 1, 0, 1;
    800,  75, 1, 0, 0;
    900,  80, 0, 1, 1;
    1000, 85, 1, 0, 1;
...
PC_Problem.Components_WithCase.Param4 = [
    300,  70, 1, 0, 1;
    500,  75, 1, 0, 0;
    700,  80, 0, 1, 1;
    900,  85, 1, 0, 1;
...
PC_Problem.Components_WithCase.Param5 = [
    400,  70, 1, 0, 1;
    600,  75, 1, 0, 0;
    800,  80, 0, 1, 1;
    1000, 85, 1, 0, 1;
...
PC_Problem.Components_WithCase.Param6 = [
    200,  70, 1, 0, 1;
    400,  75, 1, 0, 0;
    600,  80, 0, 1, 1;
    800,  85, 1, 0, 1;
...
PC_Problem.Components_WithCase.Param7 = [
    200,  70, 1, 0, 1;
    400,  75, 1, 0, 0;
    600,  80, 0, 1, 1;
    800,  85, 1, 0, 1;
...
%% 情况2: 不需要参数7的数据库（参数7的成本和性能均为0）
PC_Problem.Components_WithoutCase.Param1 = [
    750,  65, 1, 0, 1;
    850,  70, 1, 0, 0;
    950,  75, 0, 1, 1;
    1050, 80, 1, 0, 1;
...
PC_Problem.Components_WithoutCase.Param2 = [
    1500, 70, 1, 0, 1;
    1750, 75, 1, 0, 0;
    2000, 80, 0, 1, 1;
    2250, 85, 1, 0, 1;
...
PC_Problem.Components_WithoutCase.Param3 = [
    650,  65, 1, 0, 1;
    750,  70, 1, 0, 0;
    850,  75, 0, 1, 1;
    950,  80, 1, 0, 1;
...
PC_Problem.Components_WithoutCase.Param4 = [
    350,  65, 1, 0, 1;
    450,  70, 1, 0, 0;
    550,  75, 0, 1, 1;
    650,  80, 1, 0, 1;
...
PC_Problem.Components_WithoutCase.Param5 = [
    350,  65, 1, 0, 1;
    450,  70, 1, 0, 0;
    550,  75, 0, 1, 1;
    650,  80, 1, 0, 1;
...
PC_Problem.Components_WithoutCase.Param6 = [
    150,  65, 1, 0, 1;
    250,  70, 1, 0, 0;
    350,  75, 0, 1, 1;
    450,  80, 1, 0, 1;
...
% 不需要参数7时，参数7的数据全为零
PC_Problem.Components_WithoutCase.Param7 = zeros(10, 5);
